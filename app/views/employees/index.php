                ...
                <tr>
                  ...
                  <td>
                    <?php if (!empty($emp['user_id'])): ?>
                      <div><?= htmlspecialchars((string)($emp['username'] ?? '-')) ?></div>
                      <small class="text-muted"><?= htmlspecialchars((string)($emp['email'] ?? '-')) ?></small>
                    <?php else: ?>
                  ...
                  <td>
                    ...
                    <form method="post" action="employees.php?a=delete" class="d-inline">
                      <?= csrf_input() ?>
