        ...
        <div class="col-md-3 mb-3">
          <div class="card">
            <div class="card-body">
              ...
              <h3><?= (int)($pendingLoans ?? 0) ?></h3>
              <a href="loans.php" class="small">View loans</a>
            </div>
          </div>
        </div>
        <div class="col-md-3 mb-3">
          <div class="card">
            <div class="card-body">
              <h6 class="text-muted">Overdue Repayments</h6>
              <h3><?= (int)($overdueRepayments ?? 0) ?></h3>
              <a href="repayments.php" class="small">View repayments</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-md-12">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <a href="loans.php?a=create" class="btn btn-dark me-2 mb-2">Apply Loan</a>
              <a href="repayments.php?a=create" class="btn btn-secondary me-2 mb-2">Add Repayment</a>
              <a href="messages.php?a=create" class="btn btn-outline-primary me-2 mb-2">Send Message</a>
              <a href="reports.php" class="btn btn-outline-dark mb-2">Reports</a>
            </div>
          </div>
        </div>
      </div>
